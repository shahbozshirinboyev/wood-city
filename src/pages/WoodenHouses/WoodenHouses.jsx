      ...
      <section className="container mb-[25px] text-greener">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 my-[50px]">
          {getCounts(activeMenuBtn).map((card) => (
            <div
              key={card.id}
              className="border border-lighter rounded-2xl grid grid-cols-1 px-4 py-4"
            >
              {/* Card elements Start */}
              <>
              ...
              /> */}
                  ...
                  >
                    <img
                      src={card.image}
                      alt={card.title}
                      className="cursor-pointer object-cover object-center h-[350px] w-full rounded-2xl"
                    />
                  </label>
                  ...
                  <img
                    ...
                    className={` ${
                      card.plan2d === "/no_images.jpg" ? "hidden" : ""
                    } rounded-2xl cursor-pointer absolute top-3 left-3 w-[160px] hover:w-full hover:h-[350px] hover:top-0 hover:left-0 object-cover transition-all duration-300`}
                    src={card.plan2d}
                    alt=""
                  />
                </div>
                ...
                Подробнее →
                  ...
                  <label
                    className="btn ml-2 text-oranger hover:text-lighter bg-lighter hover:bg-oranger border-0"
                    htmlFor={`info_${card.id}`}
                    onClick={() => {
                      setActiveCardInfo({ card });
                    }}
                  ...
                  <div className="p-4">
                    ...
                    <form action="" className="px-6" onSubmit={handleSubmit}>
                      <label className="form-control w-full mb-2">
                        <div className="label">
                          <span className="label-text text-greener">
                            Ваше имя:
                          </span>
                      ...
                      <button className="btn my-4 w-full mr-2 text-greener hover:text-lighter bg-lighter hover:bg-greener border-0">
                        Отправить
                      </button>
                    </form>
                  </div>
                  ...
                  <div className="modal-box w-11/12 max-w-5xl p-0">
                    ...
                    >
                      ...
                      <div className="text-end">
                        <label
                          htmlFor={`info_${card.id}`}
                          className="btn btn-sm border-0 btn-circle"
                        >
                          {" "}
                          ✕{" "}
                        </label>
                    ...
                    <>
                      <div className="flex flex-col justify-between lg:flex-row gap-6 p-6">
                        ...
                        <div className="flex flex-col gap-4 lg:w-2/4 h-full">
                          <div>
                            <p className="text-2xl font-bold py-4 pb-0">
                              {card.title}
                            </p>
                          ...
                          <div>
                            <NavLink
                              to="tel:+998934563421"
                              className="mr-4 btn text-greener hover:text-lighter bg-lighter hover:bg-greener border-0"
                            >
                              Прямой звонок
                            </NavLink>
                            <button
                      ...
                      <div className="overflow-x-auto p-6">
                        <table className="table">
                          ...
                          <tbody>
                            {/* row 1 */}
                            <tr>
                              <td>Основание дома</td>
                              <td>
                                Первый ряд обвязки 100х150 150х150 200х150мм,
                                второй ряд обвязки торцевая доска соответственно
                                40х100 40х150 40х200 мм
                              </td>
                            </tr>
                            {/* row 2 */}
                            <tr>
                              <td>Стены</td>
                              <td>
                                Из каркаса 40×100 50x150 40x200 мм (в
                                зависимости от выбранного сечения) естественной
                                влажности
                              </td>
                            </tr>
                            {/* row 3 */}
                            <tr>
                              <td>Стойки</td>
                              <td>
                                Выполняются из доски естественной влажности
                                40х150 мм с шагом 590мм
                              </td>
                            </tr>
                            {/* row 4 */}
                            <tr>
                            ...
                            <tr>
                              ...
                              <td>
                                Выполняются из доски естественной влажности
                                40х100 мм с шагом 590мм
                              </td>
                            </tr>
                            {/* row 8 */}
                            <tr>
                              <td>Утепление (пол, стены, потолок)</td>
                              <td>
                                Базальтовые плиты «Rockwool» Лайт Баттс Скандик
                                150мм
                              </td>
                            </tr>
                            {/* row 9 */}
                            <tr>
                              <td>Утепление (перегородки)</td>
                              <td>
                                Базальтовые плиты «Rockwool» Лайт Баттс Скандик
                                100мм
                              </td>
                            ...
                            {/* row 10 */}
                            <tr>
                              <td>Влаго-ветрозащита</td>
                              <td>
                                Внешняя стена - Ондутис А-120. Внутренняя стена
                                - Ондутис R-70 пароизоляция или (аналоги)
                              </td>
                            </tr>
                          </tbody>
                          ...
                          <tbody>
                            ...
                            <tr>
                              <td>Стропила</td>
                              <td>
                                Обрезная доска естественной влажности 40х150мм с
                                шагом 590мм, обрезной брусок естественной
                                влажности 40х50мм
                              </td>
                            </tr>
                            {/* row 2 */}
                            <tr>
                              <td>Влаго-ветрозащита</td>
                              <td>Ондутис А-120 или (аналог)</td>
                            </tr>
                            {/* row 3 */}
                            <tr>
                              <td>Обрешетка</td>
                              <td>
                                Обрезная доска естественной влажности 20х100мм
                              </td>
                            </tr>
                            {/* row 4 */}
                            <tr>
                              <td>Кровля</td>
                              <td>
                                Профлист или «Ондулин» (цвет на выбор-красный,
                                коричневый, зелёный) вынос кровли ширина свесов
                                не менее 450мм
                              </td>
                            </tr>
                          </tbody>
                          ...
                          <tbody>
                            ...
                            <tr>
                              <td>Чистовой пол</td>
                              <td>OSB плита или половая доска 27мм</td>
                            </tr>
                            {/* row 2 */}
                            <tr>
                              <td>Внешняя и внутренняя отделка стен</td>
                              <td>OSB плита или вагонка 12,5</td>
                            </tr>
                            {/* row 3 */}
                            <tr>
                              <td>Наружная отделка елочкой</td>
                              <td>Доска 90x17/140x17 - 500 рублей за кв.м.</td>
                            </tr>
                            {/* row 4 */}
                            <tr>
                              <td>Двери</td>
                              <td>
                                Входная металлическая утеплённая,
                                межкомнатные-филёнчатые без фурнитуры
                              </td>
                            </tr>
                            {/* row 5 */}
                            <tr>
                              <td>Окна</td>
                              <td>
                                Однокамерные пластиковые. Размеры окон согласно
                                проекту
                              </td>
                            </tr>
                          </tbody>
