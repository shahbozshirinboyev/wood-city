...
function HomePage() {
  const arr = [
    ...
    },
    {
      ...
      name: "CROW",
      description:
        "Строительство деревянных домиковни по всему Узбекистану и СНГ.",
    },
    {
      id: 3,
  ...
  return (
    <section className="container text-greener">
      ...
      <div className="mb-[50px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 card card-side gap-0 md:gap-8  bg-base-100 border border-lighter bg-lighterbg p-3 rounded-[20px]">
